(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Teekay Tankers Ltd., LEI
  549300DE8ZAIYS2T6Q22, Bermuda-jurisdiction -- the first BM company in
  this actor family) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Terms of Use\nThese Terms of Use govern your access to and use of the Teekay group of companies' website, including Teekay Tankers Ltd. By using this site you agree to these Terms, which may change without notice.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.teekay.com/terms-use/"
   :retrieved-at "2026-07-10T00:00:00Z"
